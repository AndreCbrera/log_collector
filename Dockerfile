...
# Comando CORRECTO: Compila todos los archivos del paquete en el directorio actual
RUN CGO_ENABLED=0 go build -a -installsuffix cgo -ldflags '-s -w' -o /usr/local/bin/log-collector .    
# ----------------------------------------------------------------------
